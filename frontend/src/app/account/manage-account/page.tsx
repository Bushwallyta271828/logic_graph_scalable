...
export default function ManageAccount() {
  return (
    <FormCard>
      ...
      <DisplayUsername />
      <AccountForm path="users/change-username" redirectSignIn={true} onSuccess={false} usernameField="new-username">
      ...
      <AccountForm path="users/change-password" redirectSignIn={true} onSuccess={true}>
