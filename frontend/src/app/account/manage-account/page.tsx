...
export default function ManageAccount() {
  return (
    <FormCard>
      ...
      <DisplayUsername />
      <AccountForm method="PATCH" path="users/change-username" redirectSignIn={true} afterSuccess={false} usernameField="new-username">
      ...
      <AccountForm method="PATCH" path="users/change-password" redirectSignIn={true} afterSuccess={true}>
